...
//double dipole_sysval[6] = {-0.05356491705,-0.1177261332,0.1840277636,0.11339621,0.1339216988,0.1774001103};
...
void CreateDatacards_bias(bool freeZnorm = true,
  ...
  //NLO ZJets k-factors
  TFile *f = new TFile("VBFHBB_2018_DoubleB_ZJets_NLO_kfact_syst_unc.root");
  ...
  for (int i=0; i<6; ++i) {
    ...
    textfile << "shapes          wj              *   " << folder << "workspace/wj_doubleb_shapes"+suffix+".root  w:wj_$CHANNEL" << endl;
    textfile << "shapes          tt             *   " << folder << "workspace/top_doubleb_shapes"+suffix+".root  w:tt_$CHANNEL" << endl;
    textfile << "----------------------------------------------------------------------------------------------------" << endl;
    ...
    textfile << "lumi_13TeV_2018   lnN  1.015    1.015    -    1.015   1.015    1.015  1.015  1.015" << endl;
    textfile << "lumi_13TeV_1718   lnN  1.002	 1.002	  -    1.002   1.002    1.002  1.002  1.002" << endl;
    textfile << "----------------------------------------------------------------------------------------------------" << endl;
    //Offline BTAG
