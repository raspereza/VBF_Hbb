...
TString cuts[6] = {
  "bdtout_2>=0.05 && bdtout_2<0.06",
  "bdtout_2>=0.06",
  "bdtout_2<0.05 && bdtout_0>=0.4 && bdtout_0<0.6",
  "bdtout_2<0.05 && bdtout_0>=0.6",
  "bdtout_2<0.05 && bdtout_0<0.4 && bdtout_1>=0.5 && bdtout_1<0.6",
  "bdtout_2<0.05 && bdtout_0<0.4 && bdtout_1>=0.6",
};
