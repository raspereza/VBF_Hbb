...
TString cuts[6] = {
  "bdtout_2>=0.055 && bdtout_2<0.06",
  "bdtout_2>=0.06",
  "bdtout_2<0.05 && bdtout_0>=0.55 && bdtout_0<0.60",
  "bdtout_2<0.05 && bdtout_0>=0.60",
  "bdtout_2<0.05 && bdtout_0<0.4 && bdtout_1>=0.6 && bdtout_1<0.7",
  "bdtout_2<0.05 && bdtout_0<0.4 && bdtout_1>=0.7",
};
...
//double znorm[6] = {1.0,1.0,3.51,1.,1.,1.};
