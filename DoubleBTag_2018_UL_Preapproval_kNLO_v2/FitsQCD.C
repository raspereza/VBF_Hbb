...
void FitsQCD(int iCAT = 2, 
  ...
  // -----> QCD model 
  RooRealVar a1("a1_"+names[iCAT],"a1",-1,1);// a1.setVal(0.);
  RooRealVar a2("a2_"+names[iCAT],"a2",-1,1);// a2.setVal(0.);
  RooRealVar a3("a3_"+names[iCAT],"a3",-1,1);// a3.setVal(0.);
  RooRealVar a4("a4_"+names[iCAT],"a4",-1,1);// a4.setVal(0.);
  RooRealVar a5("a5_"+names[iCAT],"a5",-1,1);// a5.setVal(0.);
  ...
  RooGenericPdf QCD(polynomExpNames.at(iORDER).c_str(),genericPolynomExp.at(iORDER).c_str(),RooArgSet(mbb,argList));
