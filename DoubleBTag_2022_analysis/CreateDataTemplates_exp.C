...
void CreateDataTemplates_exp() {
	...
	TFile* file_data = new TFile(dirName + "/tree_JetMET_2022_btgsf.root");
TFile* file_zjet = new TFile(dirName + "/tree_Zto2Q-4Jets_2022_btgsf.root");
TFile* file_vbfh = new TFile(dirName + "/tree_VBFHto2B_M-125_dipoleRecoilOn_TuneCP5_13p6TeV_powheg-pythia8_2022_btgsf.root");
TFile* file_ggh  = new TFile(dirName + "/tree_GluGluHto2B_M-125_TuneCP5_13p6TeV_powheg-minlo-pythia8_2022_btgsf.root");
