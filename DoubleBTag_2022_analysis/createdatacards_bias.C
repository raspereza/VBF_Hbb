...
textfile << "shapes          qqH_hbb_bias         *   workspace/signal_resolved_vbfhbb_2022.root   w:qqH_$CHANNEL" << endl;
textfile << "shapes          ggH_hbb         *   workspace/signal_resolved_vbfhbb_2022.root   w:ggH_$CHANNEL" << endl;
textfile << "shapes          ggH_hbb_bias         *   workspace/signal_resolved_vbfhbb_2022.root   w:ggH_$CHANNEL" << endl;
...
textfile << "----------------------------------------------------------------------------------------------------" << endl;
textfile << "bin             DoubleB" << CAT[i] << "_2022   DoubleB"<< CAT[i] << "_2022   DoubleB"<< CAT[i] << "_2022   DoubleB"<< CAT[i] << "_2022   DoubleB"<< CAT[i] << "_2022   DoubleB"<< CAT[i] << "_2022" <<   endl;
...
textfile << "CMS_vbfhbb_Trig_2022     lnN     1.15/0.85  1.15/0.85    -   1.15/0.85   1.15/0.85  1.15/0.85" << endl;
...
textfile << "----------------------------------------------------------------------------------------------------" << endl;
textfile << "CMS_JES_2022  param 0.0 1.0" << endl;
...
textfile << "bias_DoubleB" << CAT[i] << "_2022	param  0 0.2" << endl;
textfile << "bias_DoubleB" << CAT[i] << "_2022	rateParam	DoubleB" << CAT[i] << "_2022   ggH_hbb_bias 0 [-1,1]" << endl;
textfile << "bias_DoubleB" << CAT[i] << "_2022  rateParam       DoubleB" << CAT[i] << "_2022   qqH_hbb_bias 0 [-1,1]" << endl;
