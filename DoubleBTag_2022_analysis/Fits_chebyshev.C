...
leg->AddEntry(xframe->findObject("qcd_curve"), "QCD", "L");
  ...
  */
  ...
  TString dir = "/eos/home-s/sapradha/www/VBFHbb_Run3/NeuralNetwork/DNN/Fits/cheb";
  canv->Print(dir+"/2022_data_cheb_pol_fit_cat_"+names[iCAT]+"_"+blinded+".png");
  canv->Print(dir+"/2022_data_cheb_pol_fit_cat_"+names[iCAT]+"_"+blinded+".pdf");
