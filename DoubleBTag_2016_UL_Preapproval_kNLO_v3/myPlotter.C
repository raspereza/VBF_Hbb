...
// Signal
   ...
   TFile *f00 = TFile::Open("../DoubleBTag_2016_UL_Preapproval/ntuples/mbb_and_bdt_all_Nom.root");
  ...
  //_Var_VBF_Hbb_H->Scale(1/_Var_VBF_Hbb_H->Integral());
     ...
     _Var_VBF_Hbb_H->SetBinContent(13, 1.03 * _Var_VBF_Hbb_H->GetBinContent(13));
     _Var_VBF_Hbb_H->SetBinContent(14, 1.07 * _Var_VBF_Hbb_H->GetBinContent(14));
  for(int ii = 15; ii < 26 ; ii++)
  {
           _Var_VBF_Hbb_H->SetBinContent(ii, 1.07 * _Var_VBF_Hbb_H->GetBinContent(ii));
  ...
  TLatex *t2a = new TLatex(0.54,0.91," #bf{CMS} #it{Preliminary}                      36.6 fb^{-1}, (2016, 13 TeV)");
  t2a->SetNDC();
  t2a->SetTextFont(42);
  ...
  text_proc->Draw("same");
   ...
   h_up2->GetXaxis()->SetTitle("Multiclass Zbb probability score");
