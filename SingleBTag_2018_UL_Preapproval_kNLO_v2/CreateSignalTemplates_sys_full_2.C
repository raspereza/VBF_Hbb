...
void CreateSignalTemplates_sys_full_2() {
  ...
  TFile * fileOutput = new TFile("root_shape/signal_singleb_shapes_2018.root","recreate");
  fileOutput->cd("");
  ...
  RooRealVar theta_SCL("CMS_scale_b_2018","CMS_scale_b_2018",0.,-5.,5.);
  RooRealVar theta_SMR("CMS_res_b_2018","CMS_res_b_2018",0.,-5.,5.);
