...
textfile << "----------------------------------------------------------------------------------------------------" << endl;
textfile << "bin             DoubleB" << CAT[i] << "_2023   DoubleB"<< CAT[i] << "_2023   DoubleB"<< CAT[i] << "_2023   DoubleB"<< CAT[i] << "_2023" << endl;
...
textfile << "PS_FSR             lnN     1.149/1.037   1.053/0.943   -   1.119/0.84  " << endl;
textfile << "CMS_vbfhbb_Trig_2023     lnN     1.15/0.85  1.15/0.85    -   1.15/0.85  " << endl;
