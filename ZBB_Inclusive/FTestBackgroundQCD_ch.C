...
void FTestBackgroundQCD_ch(int iCAT=3) {
  ...
  TFile * file = new TFile("/afs/cern.ch/work/m/mukherje/private/VBFHbb_stat/CMSSW_10_2_13/src/VBF_Hbb/ZBB_DoubleB/Inclusive_doubleB/mbb_and_bdt_all_Nom_JEC.root");
