...
void CreateDatacards_bias(bool freeZnorm = true,
			  TString folder = "SingleBTag_2018_UL_EWK"){
  ...
  for (int i=0; i<4; ++i) {
    ...
    ostringstream str;
    str << "datacards/datacards_singleb_" << names[i] << "_EWK.txt";
    string nn = str.str();
    ...
    textfile << "kmax *" << endl;
    textfile << "----------------------------------------------------------------------------------------------------" << endl;
    textfile << "shapes          qcd             *   " << folder << "/root_shape/data_singleb_shapes"+suffix+".root       w:qcd_$CHANNEL" << endl;
    textfile << "shapes          data_obs        *   " << folder << "/root_shape/data_singleb_shapes.root       w:data_$CHANNEL" << endl;
    textfile << "shapes          qqH_hbb         *   " << folder << "/root_shape/signal_singleb_shapes.root   w:qqH_$CHANNEL" << endl;
    textfile << "shapes          ggH_hbb         *   " << folder << "/root_shape/signal_singleb_shapes.root   w:ggH_$CHANNEL" << endl;
    textfile << "shapes          qqH_hbb_bias    *   " << folder << "/root_shape/signal_singleb_shapes.root   w:qqH_$CHANNEL" << endl;
    textfile << "shapes          ggH_hbb_bias    *   " << folder << "/root_shape/signal_singleb_shapes.root   w:ggH_$CHANNEL" << endl;
    textfile << "shapes          zj              *   " << folder << "/root_shape/zj_singleb_shapes.root  w:zj_$CHANNEL" << endl;
    textfile << "----------------------------------------------------------------------------------------------------" << endl;
