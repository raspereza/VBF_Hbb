...
TString DN_JEC[] = {"14.6745","-2.4750","24.2355","16.1985","11.8725"};
TString DN_JER[] = {"0.7410","2.2470","-0.0875","-2.2070","0.3160"};

TString Dmean_JEC[] = {"1.0950","3.1400","0.7640","1.6165","0.6395"};
TString DSigma_JER[] = {"0.5252","2.55105","0.1796","0.7321","0.2859"};
...
void CreateSignalPDF(int iCAT,
  ...
  RooRealVar theta_JES("CMS_vbfbb_scale_mbb_13TeV_2018","Mbb_scale",1.0,0.5,1.5);
  RooRealVar theta_JER("CMS_vbfbb_res_mbb_13TeV_2018","Mbb_scale",1.0,0.5,1.5);
    
  //RooFormulaVar yield_shifted("yield_shifted_sig_"+names[iCAT],"@0  + " + DN_JEC[iCAT] + "*@1 +"   + DN_JER[iCAT] +  "  *@2",RooArgList(yield_VBF,theta_JES,theta_JER));
  RooFormulaVar mean_shifted ("mean_shifted_sig_"+names[iCAT],"@0  + " + Dmean_JEC[iCAT] + "*@1",RooArgList(mean,theta_JES));
  RooFormulaVar sigma_shifted("sigma_res_sig_"+names[iCAT],"@0  + " + DSigma_JER[iCAT] + "*@1",RooArgList(sigma,theta_JER));
