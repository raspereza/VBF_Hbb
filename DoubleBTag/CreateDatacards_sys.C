...
void CreateDatacards_sys(bool TF = false) {
  ...
  TFile * file = new TFile("root_shapes_sys/data_doubleb_shapes"+suffix+".root");
  TFile * fileSig = new TFile("root_shapes_sys/signal_doubleb_shapes.root");
  TFile * fileTop = new TFile("root_shapes_sys/tt_doubleb_shapes.root");
  TFile * fileZj  = new TFile("root_shapes_sys/zj_doubleb_shapes.root");
...
*/
    ostringstream str;
    str << "datacards_sys/datacards_doubleb_" << names[i] << "_with_sys.txt";
    string nn = str.str();
    ...
    textfile << "kmax *" << endl;
    textfile << "----------------------------------------------------------------------------------------------------" << endl;
    textfile << "shapes          qcd             *   DoubleBTag/root_shapes_sys/data_doubleb_shapes.root       w:qcd_$CHANNEL" << endl;
    textfile << "shapes          data_obs        *   DoubleBTag/root_shapes_sys/data_doubleb_shapes.root       w:data_$CHANNEL" << endl;
    textfile << "shapes          qqH_hbb         *   DoubleBTag/root_shapes_sys/signal_doubleb_shapes.root   w:qqH_$CHANNEL" << endl;
    textfile << "shapes          ggH_hbb         *   DoubleBTag/root_shapes_sys/signal_doubleb_shapes.root   w:ggH_$CHANNEL" << endl;
    textfile << "shapes          tt              *   DoubleBTag/root_shapes_sys/tt_doubleb_shapes.root  w:tt_$CHANNEL" << endl;
    textfile << "shapes          zj              *   DoubleBTag/root_shapes_sys/zj_doubleb_shapes.root  w:zj_$CHANNEL" << endl;
    textfile << "----------------------------------------------------------------------------------------------------" << endl;
