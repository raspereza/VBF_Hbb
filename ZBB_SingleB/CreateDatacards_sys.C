...
*/
    ostringstream str;
    str << "datacards/datacards_singleb_" << names[i] << "_ZBB.txt";
    string nn = str.str();
    ...
    textfile << "kmax *" << endl;
    textfile << "----------------------------------------------------------------------------------------------------" << endl;
    textfile << "shapes          qcd             *   ZBB_SingleB/rootshape/data_singleb_shapes.root       w:qcd_$CHANNEL" << endl;
    textfile << "shapes          data_obs        *   ZBB_SingleB/rootshape/data_singleb_shapes.root       w:data_$CHANNEL" << endl;
    textfile << "shapes          qqH_hbb         *   ZBB_SingleB/rootshape/signal_singleb_shapes.root   w:qqH_$CHANNEL" << endl;
    textfile << "shapes          ggH_hbb         *   ZBB_SingleB/rootshape/signal_singleb_shapes.root   w:ggH_$CHANNEL" << endl;
    textfile << "shapes          tt              *   ZBB_SingleB/rootshape/tt_singleb_shapes.root  w:tt_$CHANNEL" << endl;
    textfile << "shapes          zj              *   ZBB_SingleB/rootshape/zj_singleb_shapes.root  w:zj_$CHANNEL" << endl;
    textfile << "shapes          wj              *   ZBB_SingleB/rootshape/wj_singleb_shapes.root  w:wj_$CHANNEL" << endl;
    textfile << "----------------------------------------------------------------------------------------------------" << endl;
    textfile << "bin             " << names[i] << endl;
    textfile << "observation   -1" << endl;
    textfile << "----------------------------------------------------------------------------------------------------" << endl;
    textfile << "bin             " << names[i] << "   " << names[i] << "   " << names[i] << "   " <<   names[i] << "   " << names[i] << "   " << names[i] << endl;
    textfile << "process          zj    qcd   tt    wj   ggH_hbb qqH_hbb" << endl;
...
/*    textfile << "CMS_BR_hbb     lnN	1.007/0.994	1.007/0.994	-      -     -" << endl;
    ...
    textfile << "CMS_norm_zj   rateParam  " << names[i] << "  zj  1 " << endl;
    textfile << endl;
  }
