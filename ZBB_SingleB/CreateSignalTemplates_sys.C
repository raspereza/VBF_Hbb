...
void CreateSignalPDF(int iCAT,
  ...
  for (unsigned int i=0; i<5; ++i) {
    ...
    treeGGH[sysName]->Draw("mbb>>"+nameGGHHist,"weight*0.7078 *(958247494.8/1662168704.0)*("+cuts[iCAT]+")");
//    treeGGH[sysName]->Draw("mbb>>"+nameGGHHist,"weight*("+cuts[iCAT]+")");
    ...
    treeGGH[sysName]->Draw("mbb>>"+nameGGHHist,"weight*0.7078 *(958247494.8/1662168704.0)");
...
void CreateSignalTemplates_sys() {
  ...
  //TFile * fileOutput = new TFile("workspace_singleb_powheg/signal_singleb_shapes.root","recreate");
  fileOutput->cd("");
